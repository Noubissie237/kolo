package com.propentatech.kolo.ui.screens.editproject
...
fun EditProjectScreen(
    ...
    // Initialiser les valeurs quand le projet est chargé
    ...
    // Si le projet n'est pas encore chargé, afficher un écran vide
    if (project == null) {
        Scaffold(
            topBar = {
                TopAppBar(
